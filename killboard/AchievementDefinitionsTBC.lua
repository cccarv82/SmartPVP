...
AchievementSystem.achievementsTbc = {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236778",
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236855",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236810",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236719",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236811",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236816",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236762",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236715",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236439",
    ...
    },
    {
        ...
        description = function(a) return ("Eliminate %d Blood Elves"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236440",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236441",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236610",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236611",
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\SmartPVP\\killboard\\img\\icons\\236392",
        achievementPoints = 25,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
