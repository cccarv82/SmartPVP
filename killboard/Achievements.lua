...
function PSC_InitializeGrayKillsCounter()
    ...
    if PSC_Debug then
        print("[SmartPVP]: Initialized gray kills counter with " .. characterData.GrayKillsCount .. " kills")
    end
end
...
function PSC_InitializeSpawnCamperCounter()
    ...
    if PSC_Debug then
        print("[SmartPVP]: Initialized spawn camper counter with " .. characterData.SpawnCamperMaxKills .. " max kills in 60s window")
    end
end
...
local function PSC_ShowUnlockedAchievements(achievementsUnlocked, unlockedList)
    ...
    if achievementsUnlocked > 3 then
        print("|cffffffff[SmartPVP]|r You have unlocked |cffffff00" .. achievementsUnlocked .. "|r new achievements:")
